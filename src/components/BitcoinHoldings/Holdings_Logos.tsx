...
const Holdings_Logos = () => {
  return (
    <main>
      <h2 className="text-[#7C7C7C] text-lg italic my-4 font-semibold">Public companies with Bitcoin holdings:</h2>
    <section className="flex flex-col gap-9 bg-white rounded-3xl p-8">
      <div>
        <Image src={TechnologyLine} alt="Tech Line" />
      ...
      <div>
        <div className="flex gap-4">
          <Image src={HealthLine} alt="Tech Line" className="w-[300px] md:w-full" />
          <Image src={FinanceLine} alt="Tech Line" className="w-[300px] md:w-full" />
          <Image src={AutoLine} alt="Tech Line" className="hidden md:flex" />
          <Image src={RealEstateLine} alt="Tech Line" className="hidden md:flex" />
        </div>
        ...
        <div className="grid grid-cols-2 md:flex gap-4">
          ...
          <div className="grid">
          <Image src={AutoLine} alt="Tech Line" className="flex md:hidden" />
            {auto.map((auto, index) => (
              <div
                key={index}
                className="flex items-center justify-center rounded-lg 
          ...
          <div className="grid">
          <Image src={RealEstateLine} alt="Tech Line" className="flex md:hidden" />
